    ...
    <section id="about" className="min-h-screen py-24 relative overflow-hidden flex items-center">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            <motion.p variants={itemVariants} className="text-lg text-stone-400 font-light leading-relaxed mb-6">
            ...
            <motion.p variants={itemVariants} className="text-lg text-stone-400 font-light leading-relaxed mb-12">
